...
```{r game1nfg, echo = TRUE, results = 'hide', comment = ""}
...
```{r game40nfg, results='hide', comment = ""}
...
```{r bestresponse, results = 'hide', comment = ""}
...
```{r mixedgraphgame, fig.align='center'}
s_jogo4$br_plot
```
...
```{r game4b, fig.align='center', comment = ""}
...
```{r game6c, echo = TRUE, fig.keep = 'none', comment = ""}
